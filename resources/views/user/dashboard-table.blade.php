              ...
              <div class="card-body p-0">
                ...
                <div class="px-4 py-3" style="max-height: 300px; overflow-y: auto;">
                  <div class="alert alert-info mb-3" role="alert">
                    <h6 class="alert-heading font-weight-bold">汇通全球虚拟信用卡平台</h6>
                  ...
                  <div class="mb-3">
                    ...
                    <ul class="list-unstyled">
                      ...
                      <li class="mb-2">• 请在交易前安排卡片充值，并确保卡内有足够的余额进行交易，或者开通自动充值的功能。</li>
                      <li>• ���果卡片不再使用，需要在绑定过的所有相关账户进行解绑后，再进行销卡动作。</li>
                    </ul>
                  </div>
                  ...
                  <p class="text-end mt-3 mb-0"><strong>汇通全球卡团队</strong></p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="p-3" style="height: 300px;">
                  <div class="d-flex flex-column justify-content-center h-100">
                    <div class="mb-4 text-center">
                      <img src="{{ asset('path/to/avatar.jpg') }}" class="rounded-circle mb-3" width="100" height="100" alt="客户经理头像">
                      <h6 class="font-weight-bold mb-1">张三</h6>
                      <p class="text-muted mb-0">资深客户经理</p>
                    </div>
                    <div class="d-flex justify-content-center">
                      <a href="https://t.me/your_telegram_username" target="_blank" class="btn btn-outline-primary me-2">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content shadow-dark-80">
      ...
      <div class="modal-body pt-2 px-4 text-center">
        <img src="{{ asset('path/to/wechat-qr.jpg') }}" class="img-fluid" alt="微信二维码">
      </div>
    </div>
  </div>
</div>
