...
<head>
    ...
    @include('partials.header-asset-new')

    @stack("css")
</head>
<body class="bg-gray-100 chat-template {{ selectedLangDir() ?? "ltr"}}">


<!-- sidebar -->
@include('user.partials.side-nav-new')

    <!-- Muze Main Content -->
<div class="main-content">

    @include('user.partials.top-nav-new')
    @yield('content')
</div>
...
@include('partials.footer-asset-new')
